...
class PaintWithWord_StableDiffusionPipeline(StableDiffusionPipeline):
    ...
    def _encode_text_color_inputs(
        ...
        return cond_embeddings.dtype, separated_word_contexts, encoder_hidden_states, uncond_encoder_hidden_states
    ...
    def __call__(
        ...
        # )
        text_embeddings_type, seperated_word_contexts, encoder_hidden_states, uncond_encoder_hidden_states = \
